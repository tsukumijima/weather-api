  ...
  <div id="changes-note" class="container mt-4 px-2 px-lg-3">
    <div class="card">
      ...
      <div class="card-body p-sm-4">
        ...
        <ul class="mb-0">
          <li>天気予報は気象庁のサイトをスクレイピングして取得しているため、<span class="text-danger">もし取得元のページに予期しないデータが入っていた場合や HTML の構造が大幅に変わった場合に、500 エラーで取得できなくなる可能性があります。</span></li>
          <ul>
            <li>万全は期しているつもりですが、アクセスする時間によってデータが変わるため、修正できていない不具合があるかもしれません。</li>
            <li>そのため、<u>天気を「確実に」取得する必要がある用途での利用は推奨しません。</u>有料サービスなども検討してください。</li>
          </ul>
